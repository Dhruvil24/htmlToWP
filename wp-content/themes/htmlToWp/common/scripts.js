        ...
        if (a == 0 && jQuery(window).scrollTop() > oTop) {
                jQuery('.counter-value').each(function () {
                        var jQuerythis = jQuery(this),
                                countDuration = jQuerythis.data('duration'),
                                countTo = jQuerythis.attr('data-count');
                        jQuery({countNum: jQuerythis.text()}).animate({countNum: countTo}, {
...
function enableRadialProgress(){
        jQuery(".radial-progress").each(function(){
                var jQuerythis = jQuery(this),
                        progPercent = jQuerythis.data('prog-percent');
...
function dropdownMenu(winWidth) {
        ...
        if (winWidth > 767) {
                ...
                jQuery('.main-menu li.drop-down').on('mouseover', function () {
                        var jQuerythis = jQuery(this),
                                menuAnchor = jQuerythis.children('a');
        ...
        if (isExists('.swiper-container')) {
                ...
                jQuery('.swiper-container').each(function (index) {
                        ...
                        var swiperDirection = jQuery(this).data('swiper-direction'),
                                ...
                                swiperScrollbar = (jQuery(this).data('scrollbar') ? jQuery(this).parentsUntil('.swiper-area').find('.swiper-scrollbar') : null);
